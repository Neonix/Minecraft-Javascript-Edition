...
import { handleGuideCommand } from './gameGuides.js';
...
export function handleExtraCommand(context) {
    if (context.message === '/2030' || context.message === '/xhelp') {
        sendSystemMessage(context.socket, '2030+: /guide, /testplan, /server, /lb, /sethome, /home, /warp, /party, /bank, /daily, /achievements, /codex, /news, /kit, /market, /contract, /rep, /economy, /backup.');
        return true;
    }
    ...
    return handleGuideCommand(context)
        || handleTravelCommand(context)
